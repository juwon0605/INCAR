...
public class RatingGiveRecyclerAdapter extends RecyclerView.Adapter<RatingGiveRecyclerAdapter.Holder> {

    private Context context;
    private List<RequestObject>list = new ArrayList<>();

    public RatingGiveRecyclerAdapter(Context context, List<RequestObject> list){
